...
<div class="panel-heading" style="background-color:#FF9900; color: #fff;">
  <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Ketua Program Studi</h3>
    ...
    <img src="<?php echo base_url('assets/images/kaprodi.jpg'); ?>" alt="" style="width: 150px; height: auto; float: left; margin: 5px;"> 
      <p style="padding:7px;">
      Nama : <a href="#">Erwin Mardinata, M.Kom</a><br>
      TTL &nbsp;&nbsp;&nbsp;: Sebewe, 07 Maret 1995
      </p>
